...
gulp.task('replacePath', function(){
    var replacePath1 = gulp.src('pages/*/*.html', { base: "./" })
        ...
        .pipe(replace('href="documentation.html"', 'href="../../documentation.html"'))
        .pipe(gulp.dest('.'));
...
var icheck = gulp.src(['./node_modules/icheck/skins/**/*'])
  .pipe(gulp.dest('./vendors/icheck/skins'));
...
gulp.task('buildOptionalVendorScripts', function() {
    return gulp.src([
      ...
      'node_modules/justgage/raphael.min.js',
      'node_modules/justgage/dist/justgage.js',
...
gulp.task('bundleVendors', gulp.series('copyRecursiveVendorFiles', 'buildBaseVendorStyles','buildBaseVendorScripts', 'buildOptionalVendorStyles', 'buildOptionalVendorScripts'));
